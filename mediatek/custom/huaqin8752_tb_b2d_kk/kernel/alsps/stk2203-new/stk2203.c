...
static int stk2203_local_init(void);
static int stk2203_remove(void);

static int stk2203_init_flag =-1; // 0<==>OK -1 <==> fail
static struct alsps_init_info stk2203_init_info = {
		.name = "stk2203",
		.init = stk2203_local_init,
		.uninit = stk2203_remove,
};
...
static int stk2203_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if((err = stk2203_create_attr(&stk2203_init_info.platform_diver_addr->driver)))
	{
...
static int stk2203_i2c_remove(struct i2c_client *client)
{
	...
	if((err = stk2203_delete_attr(&stk2203_init_info.platform_diver_addr->driver)))
	{
...
static int __init stk2203_init(void)
{
    ...
    alsps_driver_add(&stk2203_init_info);
    return 0;
}
/*----------------------------------------------------------------------------*/
